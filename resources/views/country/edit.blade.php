                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="country_name" 
                            value="{{ old('country_name') ?  old('country_name') : $country->country_name}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="short_name" 
                            value="{{ old('short_name') ?  old('short_name') : $country->short_name}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="phonecode" 
                            value="{{ old('phonecode') ?  old('phonecode') : $country->phonecode}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="continent" 
                            value="{{ old('continent') ?  old('continent') : $country->continent}}">
